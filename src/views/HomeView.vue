<template>
  <div class="home">
    ...
    <div class="form_navbar">
      <a @click="formSelector" class="form_selector--codecs navbar selected">Codecs selector</a>
      <a @click="formSelector" class="form_selector--command navbar">FFmpeg command</a>
    </div>
